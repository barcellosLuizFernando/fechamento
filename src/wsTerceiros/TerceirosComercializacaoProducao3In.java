...
/**
 * <p>Classe Java de terceirosComercializacaoProducao3In complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="terceirosComercializacaoProducao3In">
 *   &lt;complexContent>
 ...
 *         &lt;element name="rateios" type="{http://services.senior.com.br}terceirosComercializacaoProducao3InRateios" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "terceirosComercializacaoProducao3In", propOrder = {
    "cmpPrd",
    "codCcu",
    "codFil",
    "codPro",
...
public class TerceirosComercializacaoProducao3In {
    ...
    protected List<TerceirosComercializacaoProducao3InRateios> rateios;
     ...
     * {@link TerceirosComercializacaoProducao3InRateios }
     * 
     * 
     */
    public List<TerceirosComercializacaoProducao3InRateios> getRateios() {
        if (rateios == null) {
            rateios = new ArrayList<TerceirosComercializacaoProducao3InRateios>();
        }
        return this.rateios;
    }
